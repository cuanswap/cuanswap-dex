...
contract TokenPreSale is Ownable {
    ...
    function buyTokens() public payable{
        ...
        require(token.balanceOf(address(this)) >= coreAmount * tokenprice,'the smart contract dont hold the enough tokens');
        // transfer the token to the user
        token.transfer(buyer, coreAmount * tokenprice);
        // increase the token sold
        totalsold += coreAmount * tokenprice;
        // emit sell event for ui
        emit Sell(buyer, coreAmount * tokenprice);
    }
